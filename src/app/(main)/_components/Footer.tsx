...
export const Footer = () => {
  return(
    <footer className="flex items-center justify-center h-[216px] w-full bg-[#A19C9C] text-white text-[10px] md:text-sm font-semibold">
      <div className="flex items-center md:gap-x-32 gap-y-10">
        <div className="hidden md:flex flex-col gap-y-2 hover:[&>*]:opacity-60 [&>*]:transition-all [&>*]:duration-300 cursor-pointer">
        ...
        <div className="hidden md:flex flex-col gap-y-2 w-[145px]">
